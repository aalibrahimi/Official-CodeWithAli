// src/app/[locale]/blog/page.tsx - Complete Updated Version
"use client";
...
import { EnhancedCreatePostModal } from "@/MyComponents/blog/EnhancedCreatePostModal";

// Import the new components you should have created
// If these don't exist yet, comment them out for now
...
const WeeklyTechNewsletter = () => {
  ...
  const weeklySpotlights: Post[] = [
    {
      ...
      date: "2025-05-19",
      readTime: "11 min",
      category: "web-development", // Fixed the space in category
  ...
  // NEW FUNCTION: Handle post creation
  const handlePostCreated = (newPost: any) => {
    setPosts(prevPosts => [newPost, ...prevPosts]);
    console.log("New post created:", newPost);
    // You could also refresh the page or update your data here
  };
  ...
  return (
    <div className="bg-white dark:bg-black text-gray-900 dark:text-white min-h-screen">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-3 ml-50">
              ...
              <Button
                className={`text-sm font-medium ${
                  activeTab === "blog" 
                    ? "text-white bg-red-600 hover:bg-red-700" 
                    : "text-white hover:bg-red-700 bg-red-600"
                }`}
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Bell */}
              <Button className="hidden md:flex items-center justify-center h-9 w-9 rounded-full bg-red-600 hover:bg-red-700 text-white">
      ...
      <main className="min-h-screen pb-20">
            ...
            <section className="pt-10 pb-8 md:pt-16 md:pb-12 border-b border-gray-200 dark:border-gray-800">
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                  <Badge className="mb-4 bg-red-300 text-red-700 dark:bg-red-900/20 dark:text-red-400 border-transparent">
                    Weekly Tech Newsletter
                  </Badge>
                  ...
                  <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                    ...
                    practices, and innovative solutions from our team of expert
                    developers
                  </p>
                  <form
                    ...
                    <Link href={issue.url} key={issue.id}>
                      <Card className="h-full overflow-hidden hover:shadow-md transition-shadow group">
                        ...
                        <CardHeader className="pb-2">
                          ...
                          <CardTitle className="text-lg mb-2 group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors">
                            {issue.title}
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
            ...
            <section className="py-12">
              <div className="container mx-auto px-4">
                ...
                <div className="space-y-12">
                  {weeklySpotlights.map((spotlight) => (
                    <article
                      key={spotlight.id}
                      ...
                      <div className="md:col-span-8">
                        <div className="mb-3">
                          <Badge className="bg-gray-100 text-gray-700 dark:bg-gray-900 dark:text-gray-300 border-transparent">
                            {categories.find(cat => cat.slug === spotlight.category)?.name || spotlight.category}
                          </Badge>
                        </div>

                        <Link href={spotlight.url}>
                          <h3 className="font-serif text-2xl font-bold text-gray-900 dark:text-gray-300 mb-2">
                            {spotlight.title}
                          </h3>
                        </Link>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">{spotlight.excerpt}</p>

                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <Avatar className="h-8 w-8 mr-3">
                              <AvatarImage src="/codewithali.png" alt={spotlight.author.name} />
                              <AvatarFallback>{spotlight.author.name.charAt(0)}</AvatarFallback>
                            </Avatar>
                            ...
                            <div>
                              ...
                              <div className="flex items-center text-xs text-gray-600 dark:text-gray-400">
                                ...
                                <span>{formateDate(spotlight.date)}</span>
                                <span className="mx-2">•</span>
                          ...
                          <div className="flex items-center space-x-3">
                            <Button variant="ghost" size="sm" className="text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-500">
                            ...
                            <Link href={spotlight.url}>
                              <Button 
                                variant="outline"
                                size="sm"
                                className="border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-red-50 hover:text-red-600 hover:border-red-300 dark:hover:text-red-400 dark:hover:border-red-800"
                              >
                                Read More
                                <ArrowRight className="ml-2 h-4 w-4" />
                              </Button>
        ...
        {/* UPDATED BLOG TAB with Create Post Button */}
        {activeTab === "blog" && (
          <>
            {/* Blog Section */}
            <section className="py-12">
              <div className="container mx-auto px-4">
                  ...
                  <h2 className="font-serif text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">
                    ...
                    {posts.length > 0 && (
                      <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">
                        ({posts.length + bentoPosts.length} total)
                      </span>
                    )}
                  </h2>
                ...
                {/* Show newly created posts first */}
                {posts.length > 0 && (
                  <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {posts.map((post) => (
                        <Card key={post.id} className="overflow-hidden group hover:shadow-md transition-shadow border-2 border-green-200 dark:border-green-800">
                          <div className="aspect-[16/9]">
                            <Image 
                              src={post.image || "/codewithali.png"}
                              alt={post.title}
                              width={400}
                              height={225}
                          ...
                          <CardHeader className="pb-2">
                            <div className="flex justify-between items-center mb-2">
                              <Badge className="bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 border-transparent">
                                NEW: {categories.find(cat => cat.slug === post.category)?.name || post.category}
                              </Badge>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                <Avatar className="h-6 w-6 mr-2">
                                  <AvatarImage src={post.author.avatar || "/codewithali.png"} alt={post.author.name} />
                ...
                {/* Bento Grid Layout for existing posts */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Large Feature Card */}
                    ...
                    <div className="relative aspect-video">
                      ...
                      <div className="absolute bottom-6 left-6 right-6">
                        <Badge className="mb-3 bg-white/90 dark:bg-black/80 text-red-600 dark:text-red-400 border-transparent">
                          {categories.find(cat => cat.slug === bentoPosts[0].category)?.name}
                        </Badge>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <Avatar className="h-8 w-8 mr-2 border-2 border-white">
                              <AvatarImage src="/codewithali.png" alt={bentoPosts[0].author.name} />
                    ...
                    <Card key={post.id} className="overflow-hidden group hover:shadow-md transition-shadow">
                      ...
                      <CardContent>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <Avatar className="h-6 w-6 mr-2">
                              <AvatarImage src="/codewithali.png" alt={post.author.name} />
                              <AvatarFallback>{post.author.name.charAt(0)}</AvatarFallback>
                            </Avatar>
                            <span className="text-sm text-gray-900 dark:text-white">{post.author.name}</span>
                          </div>
