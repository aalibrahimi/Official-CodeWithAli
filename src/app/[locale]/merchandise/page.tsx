  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        {colors.length > 0 && (
          <div className="mt-3">
            <p className="text-xs text-red-600/70 dark:text-red-300/70 mb-1">
                ...
                <Button
                  ...
                  className={
                    activeCategory === category
                      ...
                      : "border-red-300/50 dark:border-red-800/30 text-red-500 dark:text-red-300 hover:text-red-800 dark:bg-red-950/10 hover:bg-red-400/30 dark:hover:bg-red-950/50"
                  }
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-red-300/50 dark:border-red-800/30 text-red-500 dark:text-red-300 dark:bg-red-950/10 dark:hover:bg-red-950/50 hover:bg-red-200 hover:text-red-800"
                  >
                ...
                <DropdownMenuContent
                  align="end"
                  className="bg-white dark:bg-black border-red-200/30 dark:border-red-950/30"
                >
                  <DropdownMenuItem
                    className="text-red-500 dark:text-red-300/90 cursor-pointer hover:bg-red-200 hover:text-red-800 dark:hover:text-white dark:hover:bg-red-950/30"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto bg-red-800/90 dark:bg-black/60 border-3 border-red-950/80 dark:border-red-900/40 rounded-xl p-10 text-center hover:border-red-700/60 transition-all duration-300">
            ...
            <p className="text-lg text-white/80 dark:text-red-200/70 mb-8 max-w-2xl mx-auto">
              {t("cta.desc")}
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-red-400/30 dark:border-red-800/30 text-red-950 dark:text-red-400 bg-red-200/50 dark:bg-red-950/20 hover:bg-red-200 dark:hover:bg-red-950/30 hover:text-red-700 dark:hover:text-white"
              >
                {t("cta.newsBtn")}
