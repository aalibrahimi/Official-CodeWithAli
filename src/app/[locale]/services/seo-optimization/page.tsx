/**
 * SEO Optimization service page — 2026 rewrite.
...
function Services({ t }: { t: ReturnType<typeof useTranslations> }) {
  const cards = [
    { Icon: MarkKeyword },   { Icon: MarkOnPage },   { Icon: MarkTech },
    { Icon: MarkLink },      { Icon: MarkContent },  { Icon: MarkRank },
  ];
  return (
            ...
            <FadeIn key={n} delay={i * 0.04}>
              <div className="border-t border-[#0F0F10]/15 pt-6 dark:border-white/15">
                ...
                <h3 className="mt-4 text-[18px] font-semibold tracking-tight lg:text-[20px]">
                  {t(`sections.3.approach.${n}.title`)}
                </h3>
                <p className="mt-3 text-[14px] leading-relaxed text-[#0F0F10]/65 dark:text-white/65">
                  {t(`sections.3.approach.${n}.desc`)}
                </p>
              </div>
            </FadeIn>
          ))}
                ...
                <div>
                  ...
                  >
                    <span className="text-[15px] font-semibold tracking-tight lg:text-[16.5px]">
                      {t(`sections.5.packages.${n}.title`)} {/* SEO uses packages as QA */}
                    </span>
                    <ChevronDown
...
function MarkOnPage() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="h-full w-full">
      <rect x="10" y="14" width="44" height="36" rx="2" stroke="currentColor" strokeWidth="1.2" />
      <line x1="10" y1="22" x2="54" y2="22" stroke="currentColor" strokeWidth="1.2" />
      <line x1="14" y1="28" x2="50" y2="28" stroke="currentColor" strokeWidth="1" />
      <line x1="14" y1="34" x2="50" y2="34" stroke="currentColor" strokeWidth="1" />
      <line x1="14" y1="40" x2="38" y2="40" stroke="currentColor" strokeWidth="1" />
    </svg>
  );
}
...
function MarkTech() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="h-full w-full">
      <rect x="12" y="18" width="40" height="28" rx="2" stroke="currentColor" strokeWidth="1.2" />
      <line x1="12" y1="24" x2="52" y2="24" stroke="currentColor" strokeWidth="1.2" />
...
function MarkLink() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="h-full w-full">
      <path d="M18 32 L28 22 Q32 18 38 22 L46 30" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M46 32 L36 42 Q32 46 26 42 L18 34" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" />
...
function MarkContent() {
  return (
    <svg viewBox="0 0 64 64" fill="none" className="h-full w-full">
      <path d="M16 18 L48 18 Q50 18 50 20 L50 48 Q50 50 48 50 L16 50 Q14 50 14 48 L14 20 Q14 18 16 18" stroke="currentColor" strokeWidth="1.2" />
      <line x1="20" y1="26" x2="44" y2="26" stroke="currentColor" strokeWidth="1" />
      <line x1="20" y1="34" x2="44" y2="34" stroke="currentColor" strokeWidth="1" />
      <line x1="20" y1="42" x2="36" y2="42" stroke="currentColor" strokeWidth="1" />
    </svg>
  );
}
