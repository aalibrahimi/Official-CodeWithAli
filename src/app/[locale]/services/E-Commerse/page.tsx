...
const EcommerceSolutionsPage = () => {
  ...
  return (
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-green-400 dark:border-green-800/30 text-green-700 dark:text-green-400 bg-green-100/80 dark:bg-green-950/20 hover:bg-green-200/80 dark:hover:bg-green-950/30 hover:text-green-800 dark:hover:text-white px-8"
                onClick={() =>
                  document
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={index}>
              <Card className="bg-green-200/80 text-green-800 dark:bg-black/60 dark:text-white border-green-300 dark:border-green-900 backdrop-blur-sm h-full">
                <CardContent className="p-6">
                  ...
                  <p className="text-green-700 dark:text-white/80">{feature.description}</p>
                </CardContent>
              </Card>
            </div>
          ))}
            ...
            <div key={index}>
              <Card
                className={`backdrop-blur-sm overflow-hidden ${
                  pkg.highlighted
                    ? "bg-gradient-to-r from-green-300 to-green-400 text-green-800 dark:from-green-800 dark:to-green-950 dark:text-white hover:from-green-400 hover:to-green-500 dark:hover:from-green-700 dark:hover:to-green-900"
                    : "bg-green-200/80 text-green-800 dark:bg-black/60 dark:text-white border-green-300 dark:border-green-900"
                }`}
              >
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div className="p-6 md:p-8 md:border-r border-green-300 dark:border-green-900 flex flex-col h-full md:min-h-[320px]">
                      <div>
                        {pkg.highlighted && (
                          <Badge className="bg-green-500/80 text-white dark:bg-green-900/30 dark:text-green-400 border-transparent mb-3">
                            {t("sections.3.packages.badge")}
                          </Badge>
                        )}
                        <h3 className="text-2xl font-bold text-green-700 dark:text-white">
                          {pkg.title}
                        </h3>
                      ...
                      <Button
                        className={`w-full mt-auto ${
                          pkg.highlighted
                            ? "bg-gradient-to-r from-green-500 to-green-700  dark:hover:from-green-500 dark:hover:to-green-700"
                            : "bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 dark:from-green-700 dark:to-green-900 dark:hover:from-green-600 dark:hover:to-green-800"
                        } text-white`}
                        onClick={() => router.push("/contact")}
                      >
                        {t("startBtn")}
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="text-center mb-14">
          <div>
            ...
            <p className="text-green-700 dark:text-white text-lg max-w-2xl mx-auto">
              {t("sections.4.desc")}
            </p>
          </div>
        </div>
            ...
            <div key={index} className="relative mb-10 last:mb-0">
              <div className="flex">
                <div className="flex-shrink-0 mr-6">
                  ...
                  {index < 5 && (
                    <div className="absolute top-16 bottom-0 left-8 w-0.5 bg-green-300/60 dark:bg-green-900/40"></div>
                  )}
                </div>
                <div className="pb-10">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {[
            ...
            <div
              key={index}
              className="bg-green-200/80 text-green-800 dark:bg-black/60 dark:text-white border border-green-300 dark:border-green-900 rounded-lg overflow-hidden"
            >
              <button
              ...
              >
                <p className="text-black/80 font-semibold dark:text-white/80">{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <section className="py-20 dark:bg-gradient-to-b dark:from-green-950/10 dark:to-black">
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="max-w-4xl mx-auto bg-green-200/80 text-green-800 dark:bg-black/60 dark:text-white border border-green-300 dark:border-green-900 rounded-xl p-8 md:p-12 text-center">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-green-600 dark:from-green-700 dark:to-green-900 flex items-center justify-center mx-auto mb-6">
            <ShoppingBag className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-black dark:text-white mb-6">
            {t("cta.title")}
          </h2>
          <p className="text-lg text-green-700 dark:text-white/85 mb-8 max-w-2xl mx-auto">
            {t("cta.desc")}
          </p>
          <Button
            size="lg"
