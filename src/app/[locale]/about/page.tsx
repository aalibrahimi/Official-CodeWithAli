  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-white overflow-x-hidden">
      ...
      <section className="py-20 bg-red-950/5 border-y border-red-950/20">
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-red-500/50 dark:bg-red-800/30 -translate-x-1/2"></div>
            ...
            <div className="space-y-16 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                <div className="hidden md:flex justify-end items-center">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-800 flex items-center justify-center -mr-11">
      ...
      {/* <section className="py-20 bg-red-950/5 border-y border-red-950/20">
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <div className="text-center mb-16">
            <Badge className="bg-red-600/80 dark:bg-red-900/30 dark:text-red-400 border-transparent mb-4 px-3 py-1">OUR TEAM</Badge>
            <h2 className="text-3xl text-red-500/80 dark:text-white md:text-4xl font-bold mb-6">
      ...
      {/* Values Section */}
      <section className="py-20 relative overflow-hidden">
        <div className="absolute -top-40 left-40 w-80 h-80 bg-red-500/20 dark:bg-red-900/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 right-40 w-80 h-80 bg-red-500/20 dark:bg-red-700/10 rounded-full blur-3xl"></div>
