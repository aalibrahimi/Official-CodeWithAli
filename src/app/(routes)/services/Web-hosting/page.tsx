...
const staggerContainer = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.05, // Reduced stagger time for mobile
    },
  },
};
...
const WebHostingPage = () => {
  ...
  // Add window size detection to conditionally render animations
  useEffect(() => {
    const checkIfMobile = () => {
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="pt-24 pb-12 relative">
        <div className="absolute top-0 left-0 w-full h-full z-0">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b md:bg-gradient-to-br from-red-950/30 to-transparent"></div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0">
            {[
              ...
              >
                ...
                <div className="bg-black/60 border border-red-900 rounded-xl p-6 relative z-10">
